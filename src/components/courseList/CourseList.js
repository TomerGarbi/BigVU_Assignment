...
export class CourseList extends React.Component
{
    ...
    {
        return(
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#00ff00" class="bi bi-check-lg" viewBox="0 0 16 16">
    ...
    createPlaySym = () =>
    {
        return(
            <span className='playSym'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="20" fill="currentColor" class="bi bi-play-circle" viewBox="0 0 16   16">
